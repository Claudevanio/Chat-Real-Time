...
exports.Prisma.ConfirmCodeScalarFieldEnum = makeEnum({
  id: 'id',
  code: 'code',
  userId: 'userId',
  status: 'status',
...
exports.Prisma.UserRoomScalarFieldEnum = makeEnum({
  id: 'id',
  userId: 'userId',
  roomId: 'roomId',
  createdAt: 'createdAt',
...
exports.ConfirmCodeStatus = makeEnum({
  PENDING: 'PENDING',
  USED: 'USED',
  EXPIRED: 'EXPIRED'
});

exports.ResetPasswordTokenStatus = makeEnum({
  PENDING: 'PENDING',
  USED: 'USED',
  EXPIRED: 'EXPIRED'
});
